...
int main(int argc, char *argv[])
{
    ...
    while (runTime.loop())
    {
		...
		// Copy the flux to the boundary patch(es) boundaryField
		forAll(mesh.boundary(), patchi)
		{
			// fluxPatch is already the correct face values on this patch
			const scalarField& fluxPatch = wallFlux.boundaryField()[patchi];

			// Write directly into the boundaryField of the volScalarField
			wallFluxPatch.boundaryFieldRef()[patchi] = fluxPatch;
		}
